...
```json
"@whiskeysockets/baileys": "npm:shamika-wa-baileys@1.0.8",
```

or install in terminal
```
npm install @whiskeysockets/baileys@npm:shamika-wa-baileys
```
...
### 02 BUTTON MESSAGE & INTERACTIVE MESSAGE
